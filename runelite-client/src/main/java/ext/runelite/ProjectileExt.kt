...
object ProjectileExt {
    fun Projectile.screenPoint(client: Client, graphics: Graphics2D) : Point {
    ...
    fun Projectile.drawCircle(client: Client, graphics: Graphics2D, radius: Int, drawColor: Color, fillColor: Color) {
        val point = screenPoint(client, graphics)
